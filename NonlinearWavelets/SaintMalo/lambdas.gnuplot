...
lda2(a):=(5+2*cabs(4*a+1)+2*cabs(3+8*a)+2*cabs(1-4*a)+cabs(21-32*a)+cabs(1+8*a)+cabs(24*a+11))/64;set term postscript monochrome
set term postscript monochrome
set out 'lambdas.eps'
plot [x=-1:1] lda1(x) notitle,lda2(x) notitle
