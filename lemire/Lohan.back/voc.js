...
function showBoxes() {
        ...
        for (i = 0; i < howmany; i++) {
            ...
            mycontent = mycontent + '<li style="margin-bottom:0;margin-top:0;"><input type="submit" id="speakbut' + i + '" value="Parle!" onclick=\'javascript:speak(' + i  + ');\' /><input type="text" autocorrect="off" autocomplete="off" spellcheck="false" name="lname" id="rep' + i + '" onkeypress=\'javascript:if(event.keyCode==13){checkval(' + i + ');}\'/> <input type="submit" id="but' + i + '" value="Soumettre" onclick=\'javascript:checkval(' + i + ');\' /> <span id="indice' + i + '" style="font-style: italic; color: grey;"></span></li>';
        }
